...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query("SELECT t FROM Transaction t WHERE t.user.id = :userId AND (t.wallet.id = :walletId OR t.fromWallet.id = :walletId OR t.toWallet.id = :walletId)")
